    ...
    <div className={classes.container}>
      ...
      <div className={classes.information}>
        ...
        {displayExpertise === "فیلر" && (
          <Fragment>
            <p>
              ...
              بیشتر فیلرهای HA با لیدوکائین تزریق میشوند تا ناراحتی در طول و بعد
              از درمان را به حداقل برساند
            </p>
            ...
            <div className={classes.items}>
              ...
              <div className={classes.row}>
                ...
                <p>
                  ...
                  دارای گواهینامه CLIA ، CAP و با استفاده از استانداردهای کنترل
                  کیفیت دقیق ، متعهد می شود
                </p>
              </div>
              <div className={classes.row}>
                <FiberManualRecordOutlined
        ...
        {displayExpertise === "بوتاکس" && (
          <Fragment>
            <p>
              سم بوتولینوم ( Botulinum toxin ) که با نام تجاری بوتاکس شناخته شده
              است از سم باکتری کلستریدیوم تهیه و برای فلج موقت عضلات استفاده می
              شود. تزریق بوتاکس در درجه اول به دلیل کاهش چین و چروک های صورت
              مورد توجه قرار گرفت. بوتاکس در موارد دیگری مورد استفاده قرار می
              گیرد. درمان اسپاسم گردن (دیستونی گردن)، تعریق بیش از حد
        ...
        {displayExpertise === "پلاسمای غنی از پلاکت" && (
          <Fragment>
            <p>
              ...
              مورد استفاده قرار می گیرد. همچنین ممکن است بهبود زخم را تسریع کند.
              تعدادی از متخصصان پوست از PRP برای ایجاد پوستی جوان تر برای
              بیماران استفاده می کنند. 5 ml خون از بازو بیمار گرفته شده، لایه
              حاوی پلاکت به وسیله دستگاه سانتریفیوژ جدا می شود. متخصص پوست، خونی
              را که حاوی غلظت بالایی از پلاکت ها است، با استفاده از یک سرنگ به
              صورت یا پوست سر تزریق می کند. برای افزایش اثرگذاری، متخصص پوست
              ممکن است فیلر را نیز به همراه PRP تزریق کند. اثرات کامل در عرض چند
              هفته تا چند ماه ظاهر می شود و می تواند تا 18 ماه دوام داشته باشد
            </p>
            <div className={classes.items}>
              <p className={classes.title}>مزایا</p>
              <div className={classes.row}>
        ...
        {displayExpertise === "درمان با فرکانس رادویی" && (
          <Fragment>
            <p>
              درمان با فرکانس رادیویی که RF نیز نامیده می شود ، یک روش غیرجراحی
              برای سفت کردن پوست است. امواج RF نوعی تابش است که از آزاد شدن
              انرژی به شکل امواج الکترومغناطیسی ایجاد می شود. بسته به میزان
              انرژی آزاد شده می توان امواج را به عنوان کم انرژی یا پر انرژی طبقه
              بندی کرد. پرتوهای ایکس و گاما نمونه هایی از تابش پر انرژی هستند در
              حالی که امواج RF کم انرژی در نظر گرفته می شوند. امواج RF باعث گرم
              کردن(50 تا 75 درجه سانتیگراد) لایه عمیق پوست به نام درم شده که
              باعث تحریک تولید کلاژن می شود. کلاژن رایج ترین پروتئین در بدن
              انسان است. چارچوب پوست را ایجاد می کند و به پوست استحکام می بخشد.
              با افزایش سن، سلول ها کلاژن کمتری تولید می کنند که منجر به افتادگی
              پوست و چین و چروک می شود
            </p>
            <div className={classes.items}>
              <p className={classes.title}>مزایا</p>
              <div className={classes.row}>
        ...
        {displayExpertise === "هایفوتراپی" && (
          <Fragment>
            <p>
              ...
              شوند، ولی مشاهده بیشتر نتایج تقریباً 2 تا 8 هفته بعد از درمان شروع
              می شوند، و بیشتر بیماران نتایج کامل را 12 هفته پس از انجام درمان
              می بینند
            </p>
            <div className={classes.items}>
              <p className={classes.title}>موارد استفاده</p>
