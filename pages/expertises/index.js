          ...
          {displayExpertise === "نوتریژنومیکس" && (
            <Fragment>
              ...
              <p>
                ...
                نوتریژنومیکس می باشد. این اطلاعات شامل موارد زیر است
              </p>
              <div className={classes.items}>
                <p className={classes.title}>موارد استفاده</p>
                <div className={classes.row}>
          ...
          {displayExpertise === "بوتاکس" && (
            <Fragment>
              ...
              <p>
                ...
                بوتاکس در درجه اول به دلیل کاهش چین و چروک های صورت مورد توجه
                قرار گرفت. بوتاکس در موارد دیگری مورد استفاده قرار می گیرد.
                درمان اسپاسم گردن (دیستونی گردن)، تعریق بیش از حد
          ...
          {displayExpertise === "پلاسمای غنی از پلاکت" && (
            <Fragment>
              ...
              <p>
                ...
                گرفته شده، لایه حاوی پلاکت به وسیله دستگاه سانتریفیوژ جدا می
                شود. متخصص پوست، خونی را که حاوی غلظت بالایی از پلاکت ها است، با
                استفاده از یک سرنگ به صورت یا پوست سر تزریق می کند. برای افزایش
                اثرگذاری، متخصص پوست ممکن است فیلر را نیز به همراه پلاسمای غنی
                از پلاکت تزریق کند. اثرات کامل در عرض چند هفته تا چند ماه ظاهر
                می شود و می تواند تا ۱۸ ماه دوام داشته باشد
              </p>
              <div className={classes.items}>
                <p className={classes.title}>مزایا</p>
                <div className={classes.row}>
          ...
          {displayExpertise === "درمان با فرکانس رادویی" && (
            <Fragment>
              ...
              <p>
                ...
                الکترومغناطیسی ایجاد می شود. بسته به میزان انرژی آزاد شده می
                توان امواج را به عنوان کم انرژی یا پر انرژی طبقه بندی کرد.
                پرتوهای ایکس و گاما نمونه هایی از تابش پر انرژی هستند در حالی که
                امواج رادیویی کم انرژی در نظر گرفته می شوند. امواج رادیویی باعث
                گرم کردن (۵۰ تا ۷۵ درجه سانتیگراد) لایه عمیق پوست به نام درم شده
                که باعث تحریک تولید کلاژن می شود. کلاژن رایج ترین پروتئین در بدن
                انسان است. چارچوب پوست را ایجاد می کند و به پوست استحکام می
                بخشد. با افزایش سن، سلول ها کلاژن کمتری تولید می کنند که منجر به
                افتادگی پوست و چین و چروک می شود
              </p>
              <div className={classes.items}>
                <p className={classes.title}>مزایا</p>
                <div className={classes.row}>
          ...
          {displayExpertise === "هایفوتراپی" && (
            <Fragment>
              ...
              <p>
                ...
                درمان دیده شوند، ولی مشاهده بیشتر نتایج تقریباً ۲ تا ۸ هفته بعد
                از درمان شروع می شوند، و بیشتر بیماران نتایج کامل را ۱۲ هفته پس
